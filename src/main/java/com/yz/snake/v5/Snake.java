...
public class Snake {
    ...
    public Snake(){
        ...
        tail = n;
        size = 1;
        //初始状态：node  size=1， 是头结点，方向Dir.L
        this.rectangle = new Rectangle(50+ (n.col-1) * Yard.BLOCK_SIZE, 50 + n.row * Yard.BLOCK_SIZE, Yard.BLOCK_SIZE, Yard.BLOCK_SIZE);
    }
    ...
    private void move() {
        //根据头的方向得到运动中的Snake的head的Rectangle
        switch (head.dir){
            case L:
